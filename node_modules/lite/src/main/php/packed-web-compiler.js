...
require.cached["lite/src/main/php/web-compiler.js"]=function (require,exports,module,__filename,__dirname){// node ../java/org/xidea/lite/java-proxy.js lite/src/main//web-compiler.js
...
require.cached["lite/src/main/php/php-translator.js"]=function (require,exports,module,__filename,__dirname){if(typeof require == 'function'){
...
require.cached["lite/src/main/js/parse/template-token.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
...
require.cached["lite/src/main/js/parse/translate-context.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/optimize-scope.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["js-el"]=function (require,exports,module,__filename,__dirname){module.exports = require("js-el/src/main/js/expression.js");
};
require.cached["js-el/src/main/js/expression.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["js-el/src/main/js/el-translator.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["js-el/src/main/js/expression-token.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["js-el/src/main/js/expression-tokenizer.js"]=function (require,exports,module,__filename,__dirname){if(typeof require == 'function'){
...
require.cached["js-el/src/main/js/json-tokenizer.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/js-translator.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/php/php-el-translator.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
var getTokenParam=require('js-el/src/main/js/expression-token').getTokenParam;
var getTokenParamIndex=require('js-el/src/main/js/expression-token').getTokenParamIndex;
var findTokenText=require('js-el/src/main/js/expression-token').findTokenText;
var getELType=require('js-el/src/main/js/expression-token').getELType;
var addELQute=require('js-el/src/main/js/expression-token').addELQute;
var OP_ADD=require('js-el/src/main/js/expression-token').OP_ADD;
var OP_AND=require('js-el/src/main/js/expression-token').OP_AND;
var OP_EQ=require('js-el/src/main/js/expression-token').OP_EQ;
var OP_GET=require('js-el/src/main/js/expression-token').OP_GET;
var OP_IN=require('js-el/src/main/js/expression-token').OP_IN;
var OP_INVOKE=require('js-el/src/main/js/expression-token').OP_INVOKE;
var OP_JOIN=require('js-el/src/main/js/expression-token').OP_JOIN;
var OP_NE=require('js-el/src/main/js/expression-token').OP_NE;
var OP_NOT=require('js-el/src/main/js/expression-token').OP_NOT;
var OP_OR=require('js-el/src/main/js/expression-token').OP_OR;
var OP_PUT=require('js-el/src/main/js/expression-token').OP_PUT;
var OP_QUESTION=require('js-el/src/main/js/expression-token').OP_QUESTION;
var OP_QUESTION_SELECT=require('js-el/src/main/js/expression-token').OP_QUESTION_SELECT;
var TYPE_ANY=require('js-el/src/main/js/expression-token').TYPE_ANY;
var TYPE_ARRAY=require('js-el/src/main/js/expression-token').TYPE_ARRAY;
var TYPE_BOOLEAN=require('js-el/src/main/js/expression-token').TYPE_BOOLEAN;
var TYPE_MAP=require('js-el/src/main/js/expression-token').TYPE_MAP;
var TYPE_NULL=require('js-el/src/main/js/expression-token').TYPE_NULL;
var TYPE_NUMBER=require('js-el/src/main/js/expression-token').TYPE_NUMBER;
var TYPE_STRING=require('js-el/src/main/js/expression-token').TYPE_STRING;
var VALUE_CONSTANTS=require('js-el/src/main/js/expression-token').VALUE_CONSTANTS;
var VALUE_LIST=require('js-el/src/main/js/expression-token').VALUE_LIST;
var VALUE_MAP=require('js-el/src/main/js/expression-token').VALUE_MAP;
var VALUE_VAR=require('js-el/src/main/js/expression-token').VALUE_VAR;
var getPriority=require('js-el/src/main/js/expression-tokenizer').getPriority;
var GLOBAL_DEF_MAP=require('../js/parse/js-translator').GLOBAL_DEF_MAP;
}
};
require.cached["lite/src/main/js/parse/syntax-i18n.js"]=function (require,exports,module,__filename,__dirname){var findXMLAttribute=require('./xml').findXMLAttribute;
...
require.cached["xmldom"]=function (require,exports,module,__filename,__dirname){module.exports = require("xmldom/dom-parser.js");
};
require.cached["xmldom/dom-parser.js"]=function (require,exports,module,__filename,__dirname){function DOMParser(options){
...
require.cached["xmldom/entities.js"]=function (require,exports,module,__filename,__dirname){exports.entityMap = {
       lt: '<',
       gt: '>',
       amp: '&',
       quot: '"',
...
require.cached["xmldom/sax.js"]=function (require,exports,module,__filename,__dirname){//[4]   	NameStartChar	   ::=   	":" | [A-Z] | "_" | [a-z] | [#xC0-#xD6] | [#xD8-#xF6] | [#xF8-#x2FF] | [#x370-#x37D] | [#x37F-#x1FFF] | [#x200C-#x200D] | [#x2070-#x218F] | [#x2C00-#x2FEF] | [#x3001-#xD7FF] | [#xF900-#xFDCF] | [#xFDF0-#xFFFD] | [#x10000-#xEFFFF]
...
require.cached["xmldom/dom.js"]=function (require,exports,module,__filename,__dirname){/*
 * DOM Level 2
 * Object DOMException
...
require.cached["xpath.js"]=function (require,exports,module,__filename,__dirname){module.exports = require("xpath.js/xpath.js");
};
require.cached["xpath.js/xpath.js"]=function (require,exports,module,__filename,__dirname){﻿/*
 * xpath.js
 *
...
require.cached["lite/src/main/js/parse/parse-context.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/result-context.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/optimize-util.js"]=function (require,exports,module,__filename,__dirname){/**
 * 	
...
require.cached["lite/src/main/js/parse/parse-chain.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/extension-parser.js"]=function (require,exports,module,__filename,__dirname){/**
 * @see extension.js
 */
...
require.cached["lite/src/main/js/parse/extension.js"]=function (require,exports,module,__filename,__dirname){/**
 * Lite JS 扩展规范：
 * 一个js包中：
...
require.cached["lite/src/main/js/parse/syntax-html.js"]=function (require,exports,module,__filename,__dirname){
/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
...
require.cached["lite/src/main/js/parse/el-util.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/syntax-util.js"]=function (require,exports,module,__filename,__dirname){exports.parseDefName = parseDefName;
...
require.cached["lite/src/main/js/parse/js-token.js"]=function (require,exports,module,__filename,__dirname){
...
require.cached["lite/src/main/js/parse/parse-xml.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/syntax-core.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/alive.js"]=function (require,exports,module,__filename,__dirname){/**
 * alive module
 */
var XML_SPACE_ONELINE = require('./parse-xml').XML_SPACE_ONELINE
var parseChildRemoveAttr = require('./syntax-util').parseChildRemoveAttr
...
require.cached["lite/src/main/js/parse/syntax-core-block.js"]=function (require,exports,module,__filename,__dirname){var DOCUMENT_LAYOUT_PROCESSED = "http://www.xidea.org/lite/core/c:layout-processed";
var HAS_LAZY_WIDGET = "http://www.xidea.org/lite/core/c:widget#has-lazy";
...
require.cached["lite/src/main/js/parse/syntax-text.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
...
require.cached["lite/src/main/js/parse/parse-text.js"]=function (require,exports,module,__filename,__dirname){/*
 * List Template
 * License LGPL(您可以在任何地方免费使用,但请不要吝啬您对框架本身的改进)
 * http://www.xidea.org/project/lite/
 * @author jindw
